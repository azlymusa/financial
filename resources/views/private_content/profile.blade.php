      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            ...
            <p class="text-white mt-0 mb-5">Thank you for using "az debt", any problem can directly report at <a href="" class="text-warning"><strong>azlymusa@gmail.com</strong></a></p>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group">
                        <label class="form-control-label" for="input-first-name">If you want change your email or current money, Please directly email to <a class="text-warning">azlymusa@gmail.com</a></label>
